  ...
  const handleGoogleSignup = async () => {
    try {
      ...
      await setDoc(doc(db, "users", user.uid), {
        ...
        email: user.email,
        role,
        mobile: '', // Leave empty as it’s not provided by Google
        gender: '', // Leave empty as it’s not provided by Google
        createdAt: new Date(),
      });

      alert("Google Sign-Up successful!");
      // Optionally redirect the user
      window.location.href = role === 'student' ? '/studentDashboard' : '/instructorDashboard';
